...
This script creates actual screening sessions using the populated patient data.
"""
...
async def main():
    """Main function"""
    print("🔬 EVEP Medical Portal - Create Real Screening Sessions")
    print("=" * 60)
    
    async with ScreeningSessionCreator() as creator:
