...
This script creates sample glasses inventory items for the medical system.
"""
...
class InventoryPopulator:
    ...
    def get_sample_inventory_items(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            {
                "item_code": "LENS-003",
                "item_name": "Bifocal Lens - Standard",
                "category": "lenses",
                "brand": "BifocalPro",
                "model": "BP-BIF-003",
                "specifications": {
                ...
                "reorder_level": 8,
                "supplier_info": {
                    "name": "BifocalPro Manufacturing",
                    "contact": "02-678-9012",
                    "email": "orders@bifocalpro.co.th"
                },
                "notes": "Standard bifocal lens"
            },
            ...
            {
                "item_code": "ACC-003",
                "item_name": "Eyeglass Chain - Adjustable",
                "category": "accessories",
                "brand": "ChainStyle",
                "model": "CS-003",
                "specifications": {
                    ...
                    "color": "black",
                    "length": "adjustable",
                    "features": ["breakaway_safety", "adjustable_length"]
                },
                "unit_price": 80.0,
                "cost_price": 40.0,
                "initial_stock": 150,
                "reorder_level": 30,
                "supplier_info": {
                    "name": "ChainStyle Accessories",
                    "contact": "02-901-2345",
                    "email": "sales@chainstyle.co.th"
                },
                "notes": "Safety eyeglass chain for children"
            }
        ]
    ...
    async def create_inventory_item(self, item_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            async with self.session.post(
                f"{API_BASE_URL}/api/v1/glasses-inventory/items",
                json=item_data,
                headers=headers
            ) as response:
...
async def main():
    """Main function"""
    print("🏥 EVEP Medical Portal - Glasses Inventory Population")
    print("=" * 60)
    
    async with InventoryPopulator() as populator:
