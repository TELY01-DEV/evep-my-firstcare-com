...
# Import API routers (only the ones that exist)
...
async def get_modules():
    ...
    return {
        "modules": {
            ...
            "insights": {"status": "active", "version": "1.0.0"},
            "mobile_screening": {"status": "active", "version": "1.0.0"}
        },
        "total_modules": 6,
        "enabled_modules": ["auth", "patients", "screenings", "medical_staff", "insights", "mobile_screening"]
    }
