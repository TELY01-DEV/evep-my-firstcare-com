...
async def add_teacher_fields():
    """Add CID, birth date, address, and profile photos to teachers using the API"""
        ...
        for teacher in teachers:
            try:
                ...
                update_data = {
                    ...
                    "education_level": teacher.get("education_level", ""),
                    "cid": cid,
                ...
                update_response = await session.put(
                    f"http://backend:8000/api/v1/evep/teachers/{teacher_id}",
                    json=update_data,
                ...
                if update_response.status == 200:
                    ...
                    print(f"❌ Failed to update teacher {teacher_id}: {error_text}")
...
if __name__ == "__main__":
    asyncio.run(add_teacher_fields())
